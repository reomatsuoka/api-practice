...
SEARCH_URL = 'https://app.rakuten.co.jp/services/api/BooksBook/Search/20170404?format=json&applicationId=1051380104589879585'
...
class DetailView(View):
    def get(self, request, *args, **kwargs):
        # URLにisbnを渡す。とは？→app/urls.pyの2つ目のURLのこと？
